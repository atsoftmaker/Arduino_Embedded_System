# Lab 25: Web Configuration Portal (Dynamic Provisioning)

## Overview (ภาพรวม)
ปัญหาของ Lab 23–11 คือเรา **Hardcode** ชื่อ Wi-Fi และรหัสผ่านลงในโค้ด ซึ่ง (1) ไม่ปลอดภัย (2) ต้องแก้โค้ดและ upload ใหม่ทุกครั้งที่เปลี่ยนรหัส แลปนี้แก้ปัญหาด้วยการสร้าง **Web Config Portal**:
