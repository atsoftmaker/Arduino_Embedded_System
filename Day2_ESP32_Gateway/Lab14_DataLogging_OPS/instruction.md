# Lab 14: Final Lab — Data Logging & Alert เข้า OPS Server (Realtime)
...
ESP32 จะ (1) อ่านข้อมูลเซนเซอร์จาก Node ผ่าน Modbus (Lab 13) (2) ห่อข้อมูลเป็น **JSON Data Packet** (3) ส่งขึ้น OPS Server ผ่าน HTTP POST แบบ **เรียลไทม์** และ (4) ตรวจเงื่อนไข ถ้าค่าผิดปกติให้ส่ง **Alert** พิเศษ
...
- **Wi-Fi:** TBV-WiFi (WPA2-Enterprise) — ในงานจริงดึงค่าจาก Config Portal (Lab 12)
- **เกณฑ์ Alert:** ตัวอย่างตั้ง sensor > 800 = ผิดปกติ

## Hardware Wiring
เหมือน Lab 13 ทุกประการ (ESP32 + MAX485 ↔ UNO Node บนบัส RS485)
...
void setup() {
  ...
  connectWiFi();
  Serial.println("--- Lab 14: Data Logging to OPS Server ---");
}
...
1. UNO Node (Lab 09) รันอยู่ และ VR ปรับค่าได้
